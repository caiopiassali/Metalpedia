...
abstract class Controller
{
    ...
    // Criado view Info para mostrar uma página com informações detalhadas
    protected $viewInfo;
    ...
    //..mostra a view que contém o form do relatório
    ...
    private function doListing($criteria, $orderBy)
    {
        ...
        $limit = isset($this->post['limit']) ? $this->post['limit'] : (Session::getSession("limit") != null ? Session::getSession("limit") : 10) ;

        //..ordem de registros da página
        //$orderBy = isset($this->post['orderBy']) ? $this->post['orderBy'] : '';
    ...
    public function showInfo() {
        try {
            ...
            //..se recuperou um model, então...
            if ($this->model) {
                $this->viewInfo->setModel($this->model);
            } else {
                //..senão cria a view com mensagem de não encontrado
                $this->view = new Message(Application::MSG_TITLE_DEFAULT, Application::MSG_NOT_FOUND, Application::ICON_NOT_FOUND);
            }
